...
class Pagination {
  ...
  switchPage () {
    ...
    let state = this.state
    let pCNameList = this.selectorEle(state.container + ' .page-li', true)
    let pageNumber
  ...
  gotoPage (pageNumber) {
    let state = this.state
    let evaNumberLi = this.selectorEle(state.container + ' .' + state.pageNumberCName, true)
  ...
  renderPageDOM () {
    ...
    let { totalPageCount, pCName, prevCName, disablePrevCName, pageNumberCName,
